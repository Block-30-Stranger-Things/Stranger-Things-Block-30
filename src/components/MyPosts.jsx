    ...
    {posts.map((post, index) => (
      <div key={index} className="post-item">
        ...
        <div className="post-buttons">
          <button className="delete-btn" type="button" onClick={() => deletePost(post._id)}>Delete Post</button>
          <button type="button" onClick={() => selectPost(post._id)}>Select Post</button>
        </div>
      </div>
    ))}
  </div>
